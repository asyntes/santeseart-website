...
// Exhibition pieces - full bilingual content + image paths
    ...
    <div className="min-h-screen bg-white text-black overflow-x-hidden">
      ...
      <section className="relative h-[100dvh] min-h-[640px] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
          <div className="mb-4 flex justify-center">
            <div className="inline-flex items-center gap-2 px-5 py-1.5 rounded-full bg-white/10 backdrop-blur border border-white/20 text-xs tracking-[4px] font-medium">MOSTRA ATTUALE • GIARDINI DEL SALENTO</div>
          </div>
      ...
      <section id="chi-siamo" className="max-w-6xl mx-auto px-6 pt-20 pb-16">
        ...
        <div className="mt-16 pt-12 border-t border-gray-200 grid md:grid-cols-3 gap-8 text-sm">
          <div><div className="font-medium mb-1 tracking-wide">ROCCO SANT ESE</div><div className="text-gray-500">Maestro ebanista</div></div>
      ...
      <footer className="border-t border-gray-200 bg-white">
        <div className="max-w-6xl mx-auto px-6 py-12 text-xs text-gray-500 flex flex-col md:flex-row justify-between items-center gap-y-3">
          ...
          <div className="flex gap-x-6"><span>Oria, Brindisi — Puglia, Italia</span><span className="hidden md:inline">•</span><span>Artigianato italiano di eccellenza</span></div>
        </div>
      </footer>
