...
const exhibits: Exhibit[] = [
  ...
  { id: 15, titleIt: "Cimasa di Fiori", titleEn: "Floral Cornice", dimensions: "108 cm Ø × 21.5 cm h", descriptionIt: "Cimasa in castagno con ricchi motivi floreali intagliati a mano. I fiori e le volute si aprono ai lati in un inno alla natura e alla tradizione del Salento.", descriptionEn: "Cimasa in chestnut with richly hand-carved floral motifs. Flowers and scrolls unfold on the sides in an ode to nature and the tradition of Salento.", image: "cimasa-di-fiori.jpg", price: 1500 },
  ...
  { id: 35, titleIt: "Pala di Luce", titleEn: "Paddle of Light", dimensions: "38 cm h × 30 cm", descriptionIt: "Lampada da parete touch e ricaricabile in radica di ulivo a forma di pala di fico d'india. La luce esce dai tre frutti di legno, calda e soffusa, come se la pala stesse maturando sotto il sole del Salento.", descriptionEn: "Touch and rechargeable wall lamp in olive burl shaped like a prickly pear paddle. Light emerges from the three wooden fruits, warm and soft, as if the paddle were ripening under the Salento sun.", image: "pala-di-luce.jpg", price: 180 },
];
