export const messagesEn = {
  ...
  about: {
    ...
    p2: "We are currently exhibiting a selection of works dedicated to the",
    ...
    brand: "Santese Art",
    stat1Label: "ROCCO SANTESE",
    stat1Value: "Master cabinetmaker",
    stat2Label: "CURRENT EXHIBITION",
    stat2Value: "Gardens of Salento",
