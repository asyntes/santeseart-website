...
export default function SanteseArtWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white text-black overflow-x-hidden">
      {/* Navbar - ONLY LOGO (no text repetition), forced black */}
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          >
            <img 
              ...
              alt="Santese Art" 
              className="h-9 w-auto transition-transform group-hover:scale-[1.02] brightness-0"
            />
          </div>
      ...
      <section className="relative h-[100dvh] min-h-[640px] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => scrollToSection('galleria')} className="px-8 py-4 rounded-full text-sm font-medium tracking-widest border border-white text-white hover:bg-white hover:text-black transition-all">
              SCOPRI LE OPERE
            </button>
            <button onClick={() => scrollToSection('contatti')} className="px-8 py-4 rounded-full text-sm font-medium tracking-widest bg-white text-black hover:bg-gray-100 transition-all">
