export const messagesIt = {
  ...
  hero: {
    ...
    event: "1° luglio • Palazzo Martini, Oria",
    description:
  ...
  about: {
    ...
    p2: "Dal 1° luglio esponiamo a Palazzo Martini di Oria una selezione di opere dedicate ai",
    ...
    stat2Value: "1° luglio — Palazzo Martini, Oria",
  ...
  gallery: {
    ...
    eventInfo: "1° luglio • Palazzo Martini, Oria",
    description:
